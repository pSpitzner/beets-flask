...
# ------------------------------------------------------------------------------------ #
#                                    Fields in album from MB                           #
# ------------------------------------------------------------------------------------ #

# {'album': 'Light Speed',
#  'album_id': '6075558e-b6ae-4c91-9dc7-33c76b4a01bb',
#  'albumdisambig': 'Beatport; +2 recordings',
#  'albumstatus': 'Official',
#  'albumtype': 'album',
#  'albumtypes': ['album'],
#  'artist': 'John B',
#  'artist_credit': 'John B',
#  'artist_id': '353856b7-8d79-4136-9ac6-7e47954e5be9',
#  'artist_sort': 'B, John',
#  'artists': ['John B'],
#  'artists_credit': ['John B'],
#  'artists_ids': ['353856b7-8d79-4136-9ac6-7e47954e5be9'],
#  'artists_sort': ['B, John'],
#  'asin': None,
#  'barcode': None,
#  'catalognum': 'BETACD007',
#  'country': 'XW',
#  'data_source': 'MusicBrainz',
#  'data_url': 'https://musicbrainz.org/release/6075558e-b6ae-4c91-9dc7-33c76b4a01bb',
#  'day': 6,
...
#  'original_month': 2,
#  'original_year': 2012,
#  'release_group_title': 'Light Speed',
#  'releasegroup_id': '2aef311a-588c-400e-897a-88a1399a92b3',
