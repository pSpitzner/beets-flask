        ...
        >
            <Paper>
                <Typography variant="body1" sx={{ padding: "1rem" }}>
                    ...
                    dignissimos tenetur natus consectetur repellat provident ipsa nam
                    accusamus et labore sequi praesentium expedita nobis, dicta cum
                    voluptate. Nam necessitatibus aliquid laboriosam, cum accusantium
                    recusandae eveniet aspernatur blanditiis deserunt maxime adipisci
...
export function PathBreadcrumbs({ folder }: { folder: Folder }) {
    ...
    const items = [
        ...
        />,
        ...path.map((name, i) => (
            <BreadCrumbItem key={i} name={name} isLast={i === path.length - 1} />
        )),
    ];
